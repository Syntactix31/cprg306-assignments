...
export default function Page() {
  return (
    <main>
      ...
      <div className="my-20">
        <Link href="/week-7"className="mx-auto flex max-w-sm items-center gap-x-4 rounded-xl bg-white p-6 shadow-lg outline outline-black/5 dark:bg-slate-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10 hover:bg-red-200 min-width-week">Week-7 &#10140;</Link>
      </div>
